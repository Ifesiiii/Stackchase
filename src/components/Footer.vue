...
<template>
  <footer class="font-heading mx-auto bg-[#13212F] text-[#E5E5E5] py-[72px] px-6">
    <div class="max-w-7xl max-w-screen-[1366px] mx-auto">
      <!-- Main Footer Content -->
      <div class="flex flex-col lg:flex-row justify-between gap-12 mb-6">
        <!-- Company Info -->
        <div class="lg:w-[45%]">
      ...
      <!-- Bottom Bar -->
      <div class="border-t border-[#2A3F52] pt-8">
        <!-- Mobile Layout -->
        <div class="md:hidden flex flex-col gap-6">
          <div class="flex justify-between items-center">
            ...
            <div class="flex items-center gap-4">
              <!-- Email -->
              <a href="mailto:support@lopworks.com" class="hover:opacity-80 transition-opacity">
          ...
          <!-- Copyright -->
          <div class="flex items-start gap-2 text-sm leading-7">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" class="flex-shrink-0 mt-0.5">
