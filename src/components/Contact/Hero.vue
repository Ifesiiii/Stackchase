...
<template>
    <section class="font-heading relative overflow-hidden mx-auto mb-[100px] max-w-screen-[1366px]">
      ...
      <div class="relative z-10 mx-8 xl:mx-[80px] mt-[48px]">
        ...
        <!-- Hero Content -->
        <div class="mt-[24px] lg:mt-[80px] mb-[87px] lg:mb-[200px]">
          <div class="max-w-7xl">
            <p class="text-[#FFB343] text-lg sm:text-[24px] mb-6 sm:mb-8 leading-[24px] sm:leading-[28px] tracking-[0.2px]">Contact Us</p>
