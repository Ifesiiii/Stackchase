    ...
    <section class="font-heading relative min-h-screen overflow-hidden mx-auto mb-[100px] max-w-screen-[1366px]">
      ...
      <div class="absolute inset-0">
        <img 
          :src="cosmos" 
          alt="" 
          class="w-full h-[1113px] object-cover" 
        />
      </div>
      ...
      <div class="relative z-10 mx-8 xl:mx-[80px] mt-[48px]">
        ...
        <!-- Hero Content -->
        <div class="mt-[24px] lg:mt-[80px]">
          <div class="max-w-7xl">
            <p class="text-[#FFB343] text-lg sm:text-[24px] mb-6 sm:mb-8 leading-[24px] sm:leading-[28px] tracking-[0.2px]">About Us</p>
